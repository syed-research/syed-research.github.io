...
The CLIMATE Research Group brings together researchers working across thermochemical engineering, CO₂ utilisation, chemical looping, and sustainable energy systems. Our work integrates experimental, computational, and analytical expertise to advance next‑generation decarbonisation technologies.
...
<div class="fade-in">
<h3>Adnan Akhtar — PhD Researcher (3rd Year)</h3>
<p><a href="https://scholar.google.co.uk/citations?user=raYhhRYAAAAJ&hl=en&oi=ao" target="_blank">Google Scholar</a></p>
<p>
Adnan works on chemical looping, CO₂ utilisation, and high‑temperature reaction engineering, focusing on oxygen‑carrier development, fixed‑bed studies, and TGA‑based kinetic analysis.
</p>
</div>

<div class="fade-in">
<h3>Fahad Maqbool — PhD Researcher (1st Year)</h3>
<p><a href="https://scholar.google.co.uk/citations?user=v7cztUwAAAAJ&hl=en&oi=ao" target="_blank">Google Scholar</a></p>
<p>
Fahad focuses on thermochemical CO₂ conversion, reactor‑scale modelling, kinetic modelling, and CFD‑supported optimisation of high‑temperature systems.
</p>
</div>
...
<h3>Position Open</h3>
<p>
We welcome PhD applicants with backgrounds in chemical engineering, materials science, mechanical engineering, energy systems, and computational modelling.
</p>
</div>
...
<div class="fade-in">
<p>
We are always looking for motivated researchers to join the CLIMATE Research Group at the University of Southampton.
</p>
