...
The CLIMATE Research Group operates advanced experimental and computational facilities for **chemical looping**, **CO₂ utilisation**, **materials synthesis**, and **reactor engineering**. Our laboratory supports high‑temperature, multi‑cycle experiments under both atmospheric and high‑pressure conditions, complemented by state‑of‑the‑art analytical and characterisation tools.

---

## Chemical Looping Reactor Systems

We maintain a fully operational reactor platform designed for multi‑cycle redox experiments:

- **Packed‑bed reactor** enclosed in a **Carbolite split furnace** (high‑temperature operation)
- **Atmospheric and high‑pressure capability**
- **Automated multi‑cycle operation** for long‑duration looping studies
- **Multiple mass flow controllers (MFCs)** for precise gas delivery (air, N₂, CO₂, H₂, CH₄, syngas mixtures)
...
This system enables detailed investigation of oxygen carriers, redox kinetics, and reactor performance under industrially relevant conditions.
...
Our group has access to a comprehensive suite of material‑characterisation tools, including:
